...
// Renamed from CreateAccountActivity to RegisterActivity
class RegisterActivity : ComponentActivity() { // <--- CHANGED HERE
...
//
                ...
                Text(
                    text = "Get started on your journey to happy pet care!",
    ...
    fun MyInputText(
        ...
        Column(
            ...
            TextField(
                ...
                label = { Text("Username") },
                placeholder = { Text("e.g., malupet_owner") },
                singleLine = true,
